 ...
 */
public class TopRatedFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void updateMovies() {
        ...
        new CommonAsyncTask(this, StringConstants.TOP_RATED_REQUEST).execute("1");
    }
                ...
                if (dy > 0) {
                    ...
                    if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                        if (loading && pageCount <= 40) {
                            ...
                            Log.v("...", "Last Item Wow !");
                            pageCount++;
                            new CommonAsyncTask(TopRatedFragment.this, StringConstants.TOP_RATED_REQUEST).execute(Integer.toString(pageCount));
